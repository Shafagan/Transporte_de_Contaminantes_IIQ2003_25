...
14) Se asume que caudal promedio (q_adv_tracer en código) es igual al caudal impuesto.
15) No hay evaporación.
16) Humedad inicial estimada a partir de un 30 % de la humedad saturada θ_s dado por un clima frío.
17) No se forma un exceso de agua sobre la superficie del relave.
...
Si esta en otra terminal como VS code verifique tener instaladas las librerías numpy y matplotlib, caso contrario, instalar según la documentación del terminal y las características del dispositivo (mac, linux o windows). Ejecute el archivo main.ipynb
